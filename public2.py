...
from googletrans import Translator #janganlupa pip2 install gTTS & Dan lain lain v:
...
creator=["u63c3abd264a36812c1d2d36f87386c5a","u63c3abd264a36812c1d2d36f87386c5a"]
owner=["u63c3abd264a36812c1d2d36f87386c5a","u63c3abd264a36812c1d2d36f87386c5a"]
wait = {
    'contact':False,
    'autoJoin':True,
    ...
    'timeline':False,
    'autoAdd':True,
    'message':""" »»»Thx For Add! «««👉Bots By ༺̹̮P̬͎͍̤͙̠̙̦̦̻̼͔̤͎͖̼͕̭͕̹̂̂ͤ͗̄́͆̇ͤͮ̔e̫̪̤̠̗ͨ̅͛ͪ̄ͦ͛̄̑̍̊̓̌͊p̪̺͇̺̱̱̤͔̳͚̜̤͓̲͙ͩ͌͂ͩ̇̀́̑̓̃͆̃̆̄̒̉e͈̮̲̰͚̖͈ͮ̀̅ͭ͌ͪͯ̔͂ͥͦ͒̓̎̽ͧ̀n͖̟̳̙͖͔͇̦̪̘͖̟͊̍👈 »»» http://line.me/ti/p/~pepenlagiboker «««""",
    "lang":"JP",
...
#------------------NOTIFIED_READ_MESSAGE----------------#
        ...
        if op.type == 26:
            ...
            if "@"+cl.getProfile().displayName in msg.text:
                if wait["tag"] == True:
                    ...
                    jawab = ("Kenapa Tag Si "+cl.getProfile().displayName+"Kangen yah..!!!\nPC aja langsung biar anu hihi..!!\n[autoRespon]by=>~Pepen\n👉Team Rewel Bots👈","Nah ngetag lagi si "+cl.getProfile().displayName+" mending ajak mojok aja dari pada ngetag mulu.. wkwk...!!!\n[autoRespon]by=>~Pepen\n👉Team Rewel Bots👈")
        ...
        if op.type == 26:
            ...
            if "@"+cl.getProfile().displayName in msg.text:
                if wait["tag2"] == True:
                    tanya = msg.text.replace("@"+cl.getProfile().displayName,"")
                    jawab = "Kenapa Tag Si "+cl.getProfile().displayName+"Kangen yah..!!!\nPC aja langsung biar anu hihi..!!\n[autoRespon]by=>~Pepen\","Nah ngetag lagi si "+cl.getProfile().displayName+" mending ajak mojok aja dari pada ngetag mulu.. wkwk...!!!\n[autoRespon]by=>SelfBot~Pepe.\n"
                    jawaban = random.choice(jawab)
                    cl.sendText(msg.to,jawaban)
...
#-----------------------------------------------
				...
				if msg.from_ in admin or owner:
					cl.sendText(msg.to,"Pn Hadir Boss!!")
#-----------------------------------------------
