...
cl = PEPEN.LINE()
#cl.login(qr=True)
cl.login(token='IsiToken') #Ranita
cl.loginResult()#
...
helpMessage ="""
╔═════════════
║    ✰ T̤̜̦̻̉͐͂̊̽̌̄̄ẽ̥̰͓̟̮̙̪͍̻̬͍͙͎͂ͪ̉ͯa̹͉̮̝͚̻͇̯͙̤ͯ̅̋̃̇m̦͎̺͍̹͔̳̹͙̤͈͌̿̈́ͮ̂ͦ̔̌́̆́̆ͧͫ͆͐ͤ͌s̙͇͕ͯ̍ͅ ͕̹͍̮̰͉̺̟̪̫̘͙͔̜̣̀ͮ̀͐ͭͥ̉̐̒E̺̜̞̰̾̄ͦ́͒̍͆͒̌̃́̒̽́a͕͎̳̪͇̹̙͙̱̭͎̝̠̜̘͊̌̅̎ͮͯ̓̈́͒ͮg͚̋̋ͭͧ́ͨ͛̂ͭ͋́ͤ̉ͫl̹͈̥͉̹̩̱̪̹ͨͤͬ̇̿̈́ͦ̏ͭͥ̿̂̓ͪ̌͂ͤ͑ͫͥé̦͖͉͖̝̦̖̗̦̥̄̆ͮ̓̃̓̑̏͑ͩ̔̽͂ͬ̀͆ͥ̀ͣͅ ̞̳͕̜̠̲̖̗͉ͬ̆͋ͮ͋̒̈̐͂B͚͖̹̹ͧ̌͂̔̽ͭo͖̭̭̻̲͍͓͉̬͓̰̠̮͔̩̭͔ͬ͗̐ͤ̾ͯ͌̓̉͋̌̄̆̐̅͊ͧt̳͓͎̊͆̽̒͂̋̓͒͊͒̚̚s̝̻̪̳͎̙͔̲̪͓̥ͭͥ̈̽̈̃̈́ͮ̄̊̐ͣ̒̉ͨͭ̚ͅ ✰
╠═════════════
║      Owner : Ṗ̞̄̉̇͌̃͗͒̑e̫̺̙̹̻̥̯̝̤̹̜̟̣̫ͪ͌̄̌̉̒ͤ̌̄͆̊͊̍ͦ̃̆ͣp͔̲̞̩̻̹̓͛ͯ͒͌̆̈͛̄̌̓̽̑̀ĕ̯͎͙̮̝̠ͮṇ̗̲̲̯͍̩ͨͭͫ
...
║╠☔Absen
║╠☔Gift
║╠☔Pepen pergi (ngeluarkan bot)
║╠☔Pn pergi (ngeluarkan bot)
║╚════════════
║   UNTUK PUBLIK
║ SILAHKAN GUNAKAN
╚═════════════
...
creator=["u63c3abd264a36812c1d2d36f87386c5a"]
owner=["u63c3abd264a36812c1d2d36f87386c5a"]
wait = {
    'contact':False,
    'autoJoin':True,
    ...
    'timeline':False,
    'autoAdd':True,
    'message':""" »»»Thx For Add! «««👉Bots By Pepen👈 »»» http://line.me/ti/p/~pepenlagiboker «««""",
    "lang":"JP",
    "comment":"""👉😊☆º°˚˚☆✰ T̤̜̦̻̉͐͂̊̽̌̄̄ẽ̥̰͓̟̮̙̪͍̻̬͍͙͎͂ͪ̉ͯa̹͉̮̝͚̻͇̯͙̤ͯ̅̋̃̇m̦͎̺͍̹͔̳̹͙̤͈͌̿̈́ͮ̂ͦ̔̌́̆́̆ͧͫ͆͐ͤ͌s̙͇͕ͯ̍ͅ ͕̹͍̮̰͉̺̟̪̫̘͙͔̜̣̀ͮ̀͐ͭͥ̉̐̒E̺̜̞̰̾̄ͦ́͒̍͆͒̌̃́̒̽́a͕͎̳̪͇̹̙͙̱̭͎̝̠̜̘͊̌̅̎ͮͯ̓̈́͒ͮg͚̋̋ͭͧ́ͨ͛̂ͭ͋́ͤ̉ͫl̹͈̥͉̹̩̱̪̹ͨͤͬ̇̿̈́ͦ̏ͭͥ̿̂̓ͪ̌͂ͤ͑ͫͥé̦͖͉͖̝̦̖̗̦̥̄̆ͮ̓̃̓̑̏͑ͩ̔̽͂ͬ̀͆ͥ̀ͣͅ ̞̳͕̜̠̲̖̗͉ͬ̆͋ͮ͋̒̈̐͂B͚͖̹̹ͧ̌͂̔̽ͭo͖̭̭̻̲͍͓͉̬͓̰̠̮͔̩̭͔ͬ͗̐ͤ̾ͯ͌̓̉͋̌̄̆̐̅͊ͧt̳͓͎̊͆̽̒͂̋̓͒͊͒̚̚s̝̻̪̳͎̙͔̲̪͓̥ͭͥ̈̽̈̃̈́ͮ̄̊̐ͣ̒̉ͨͭ̚ͅ ✰☆º°˚˚☆（＾ω＾）\n\nby Pepen ⭐👈 »»» http://line.me/ti/p/~pepenlagiboker «««""", #jangandiganti
    "commentOn":False,
    "commentBlack":{},
    "wblack":False,
    "dblack":False,
...
#						cl.comment(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],"Auto Like By Pepen!!\nID LINE : line://ti/p/~pepenlagiboker")
#						print "DiLike"
#					except:
#							pass
#				else:
...
#        try:
#          cl.like(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],likeType=1002)
#          cl.comment(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],"👉ąµţ๏ℓɨЌ€ By Pepen")
#          print "Like"
#        except:
#          pass
#      else:
    ...
    try:
        ...
        if op.type == 13:
            if wait["auto"] == True:
                ...
                cl.sendText(op.param1, "Makasih Dah Invite~Ketik(Help)UntukMelihatKeywordBotnya Ya!                  			Ingat Ini Bot Publik bisa di gunakan semua orang!")
        if op.type == 5:
...
#--------------------------------------------------
            elif ("Pn gn " in msg.text):
				if msg.from_ in admin or owner:
					if msg.toType == 2:
						X = cl.getGroup(msg.to)
						X.name = msg.text.replace("Pn1 gn ","")
						ki.updateGroup(X)
					else:
						cl.sendText(msg.to,"It can't be used besides the group.")
#--------------------------------------------------
            elif ("Pn2 gn " in msg.text):
				if msg.from_ in admin or owner:
					if msg.toType == 2:
						X = cl.getGroup(msg.to)
						X.name = msg.text.replace("Pn2 gn ","")
						kk.updateGroup(X)
					else:
						cl.sendText(msg.to,"It can't be used besides the group.")
#--------------------------------------------------
            elif ("Pn3 gn " in msg.text):
				if msg.from_ in admin or owner:
					if msg.toType == 2:
						X = cl.getGroup(msg.to)
						X.name = msg.text.replace("Pn3 gn ","")
						kc.updateGroup(X)
					else:
...
#--------------------------------------------------
				...
				if msg.from_ in admin or owner:
					...
					ki.sendMessage(msg)
#--------------------------------------------------
            elif msg.text in ["Pn2"]:
				if msg.from_ in admin or owner:
					msg.contentType = 13
					msg.contentMetadata = {'mid': Bmid}
					kk.sendMessage(msg)
#--------------------------------------------------
            elif msg.text in ["cancel","Pn cancel"]:
				if msg.from_ in admin or owner:
					if msg.toType == 2:
...
#--------------------------------------------------
            elif msg.text in ["Pn1 ourl","Pn1 link on"]:
				if msg.from_ in admin or owner:
					if msg.toType == 2:
						X = cl.getGroup(msg.to)
						X.preventJoinByTicket = False
...
#--------------------------------------------------
				...
				if msg.from_ in admin or owner:
					cl.sendText(msg.to,mid)
#--------------------------------------------------
            elif "Pn1 mid" == msg.text:
				if msg.from_ in admin or owner:
					cl.sendText(msg.to,Amid)
#--------------------------------------------------
            elif "Pn2 mid" == msg.text:
				if msg.from_ in admin or owner:
					cl.sendText(msg.to,Bmid)
#--------------------------------------------------
            elif "Pn3 mid" == msg.text:
				if msg.from_ in admin or owner:
					kc.sendText(msg.to,Cmid)
#--------------------------------------------------
...
#--------------------------------------------------
            elif msg.text in ["Pn1 rename "]:
				if msg.from_ in admin or owner:
					string = msg.text.replace("Pn1 rename ","")
...
#--------------------------------------------------
            elif msg.text in ["Pn2 rename "]:
				if msg.from_ in admin or owner:
					string = msg.text.replace("Pn2 rename ","")
					if len(string.decode('utf-8')) <= 20:
              ...
              if msg.from_ in admin or owner:
                if wait["Protectguest"] == False:
                    ...
                    if wait["lang"] == "JP":
                        ...
                        cl.sendText(msg.to,"done")
#--------------------------------------------------
            elif msg.text in ["Ã©â‚¬Â£Ã§ÂµÂ¡Ã¥â�1�7�1�71¤7¦Ë 1�71¤7:Ã£â€šÂªÃ£Æ�1�7�Â�1�7�1�71¤7","P on","Contact on","Ã©Â¡Â¯Ã§Â¤ÂºÃ¯Â¼Å¡Ã©â€�1�7�â�1�7�1�71¤7 1�71¤7"]:
				if msg.from_ in admin or owner:
					if wait["contact"] == True:
						...
						if wait["lang"] == "JP":
							...
							cl.sendText(msg.to,"done")
#--------------------------------------------------
            elif msg.text in ["Ã©â‚¬Â£Ã§ÂµÂ¡Ã¥â�1�7�1�71¤7¦Ë 1�71¤7:Ã£â€šÂªÃ£Æ�1�7�â�1�7�1�71¤7 1�71¤7","P off","Contact off","Ã©Â¡Â¯Ã§Â¤ÂºÃ¯Â¼Å¡Ã©â€�1�7�Å�1�7�1�71¤7"]:
				if msg.from_ in admin or owner:
...
#-----------------------------------------------
				...
				if msg.from_ in admin or owner:
					cl.sendText(msg.to,"Hadir Boss!! LagI Coly")
#-----------------------------------------------
                ...
                if msg.from_ in admin or owner:
                    if wait["MProtection"] == False:
                        ...
                        if wait["lang"] == "JP":
                            ...
                            cl.sendText(msg.to,"done")
#-----------------------------------------------
            elif "Pn say " in msg.text:
					bctxt = msg.text.replace("Pn say ","")
					...
					cl.sendText(msg.to,"Di Add Yak")
					ki.sendMessage(msg)
					msg.contentType = 13
					msg.contentMetadata = {'mid': "u63c3abd264a36812c1d2d36f87386c5a"}
					cl.sendText(msg.to,"Creator Yg Paling Manis :v")
...
#--------------------------------------
			...
			#elif msg.text in ["-,-"]: #JikaGabisaHapusAjaNihSC!
				#if wait["-,-"] == True
				#tanya = msg.text.replace("-,-"+cl.getProfile().displayName,"")
                    #jawab = ("napa pakai emot -,- "+cl.getProfile().displayName+"Wkwkek napa dah pakai emot -,-","cemburut yak :V"+cl.getProfile().displayName+" Ngentot aja sono v:")
                    #jawaban = random.choice(jawab)
                    #cl.sendText(msg.to,jawaban)
#-----------------------------------------------
#-------------- Add Friends ------------
...
#-----------------------------------------------
				...
				if msg.from_ in admin or owner:
					cl.sendText(msg.to,"Hdr 1")
					cl.sendText(msg.to,"Hdr 2")
					cl.sendText(msg.to,"Hdr 3")
            elif msg.text in ["Absen"]:
                    cl.sendText(msg.to,"👉JAGOMatIHadir :V")
                    cl.sendText(msg.to,"👉TukangHomoHadir! :V")
                    cl.sendText(msg.to,"👉JagoCrotHadir :V")
                    cl.sendText(msg.to,"👉TukangCrotHadir :V")
                    cl.sendText(msg.to,"👉TukangNgentotHadir :V")
...
#--------------------------------------------------------
            elif msg.text in ["Sp","Speed",".Crot"]:
				if msg.from_ in admin or owner:
					start = time.time()
...
#------------------------------------------------------------------
            ...
            elif msg.text in ["Pepen glist"]: #Melihat List Group
                if msg.from_ in owner:
                    gids = cl.getGroupIdsJoined()
                    h = ""
                    for i in gids:
                ...
                if msg.from_ in owner:
                    if msg.toType == 2:
                        ...
                        try:
                            ...
                            pass
            elif "pepen megs " in msg.text:
                if msg.from_ in owner:
                    gName = msg.text.replace("pepen megs ","")
                    ...
                    for a in nya:
                        ...
                        cl.createGroup(gName, semua)
                        cl.createGroup(gName, semua)
            elif "#pmegs " in msg.text:
                if msg.from_ in owner:
                    gName = msg.text.replace("#pmegs ","")
                    ap = cl.getGroups([msg.to])
            ...
            elif msg.text in ["pepen muach"]:
                if msg.from_ in owner:
                    msg.contentType = 13
                    msg.contentMetadata = {'mid': "ua7fb5762d5066629323d113e1266e8ca',"}
                    cl.sendMessage(msg)
            elif msg.text in ["Pepen","Pepen"]:
                if msg.from_ in owner:
                    cl.sendText(msg.to,"Pepen masih aktif :*...!!!")
